...
const urlsToCache = [
  ...
  '/mary-nails-art/utils/push-config.js',
  '/mary-nails-art/utils/push-notifications.js'
];
...
self.addEventListener('push', event => {
  ...
  const options = {
    ...
    icon: '/mary-nails-art/icons/icon-192x192.png',
    badge: '/mary-nails-art/icons/icon-96x96.png',
    tag: payload.tag || 'rservasroma',
    data: {
      url: payload.url || '/mary-nails-art/admin.html',
      ...(payload.data || {})
    }
  };
...
self.addEventListener('notificationclick', event => {
  ...
  const targetUrl = event.notification?.data?.url || '/mary-nails-art/admin.html';
  event.waitUntil(
